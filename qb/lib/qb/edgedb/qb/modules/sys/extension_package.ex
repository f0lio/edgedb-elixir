defmodule(QB.EdgeDB.QB.Modules.Sys.ExtensionPackage) do
  [
    (
      @properties [
      ...
      @backlinks [
                 ...
                 |> Enum.concat([:"<package[is schema::Extension]"])
                 |> List.flatten()
      @backlink_stubs [
                        QB.EdgeDB.QB.Modules.Sys.SystemObject,
                        QB.EdgeDB.QB.Modules.Schema.AnnotationSubject
      ...
      (
        object_name = :extension_package
        type_id = "71a075c2-8a10-11ec-b931-ed6ae24a5f34"
