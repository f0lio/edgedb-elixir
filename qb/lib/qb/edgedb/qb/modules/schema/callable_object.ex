  ...
  [
    (
      ...
      @links [QB.EdgeDB.QB.Modules.Schema.AnnotationSubject]
             ...
             |> Enum.concat([:params, :return_type])
             |> List.flatten()
      ...
      (
        object_name = :callable_object
        type_id = "6dd14eb7-8a10-11ec-b180-493af67bf9e1"
