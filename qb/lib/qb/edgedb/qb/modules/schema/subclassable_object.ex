defmodule(QB.EdgeDB.QB.Modules.Schema.SubclassableObject) do
  [
    (
      @properties [QB.EdgeDB.QB.Modules.Schema.Object]
                  |> Enum.map(fn base -> base.__properties__() end)
                  |> Enum.concat([:abstract, :is_abstract, :final, :is_final])
                  |> List.flatten()
      ...
      @backlink_stubs [QB.EdgeDB.QB.Modules.Schema.Object]
                      ...
                      |> List.flatten()
      (
        object_name = :subclassable_object
        card = :many
      ...
      (
        object_name = :subclassable_object
        type_id = "6c83561f-8a10-11ec-bc8a-c757b42dec44"
