defmodule(QB.EdgeDB.QB.Modules.Schema.TupleElement) do
  [
    (
      ...
      @backlinks [QB.EdgeDB.QB.Modules.Std.BaseObject]
                 ...
                 |> Enum.concat([:"<element_types[is schema::Tuple]"])
                 |> List.flatten()
      ...
      (
        object_name = :tuple_element
        type_id = "6d362a1b-8a10-11ec-be37-b30418a69bcc"
