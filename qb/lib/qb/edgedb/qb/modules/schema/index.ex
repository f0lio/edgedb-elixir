defmodule(QB.EdgeDB.QB.Modules.Schema.Index) do
  [
    (
      ...
      @backlinks [QB.EdgeDB.QB.Modules.Schema.AnnotationSubject]
                 ...
                 |> Enum.concat([
                   :"<indexes[is schema::Source]",
                   :"<indexes[is schema::Link]",
                   :"<indexes[is schema::ObjectType]"
                 ])
                 |> List.flatten()
      ...
      (
        object_name = :index
        type_id = "6e946f77-8a10-11ec-948c-2fb05007b715"
